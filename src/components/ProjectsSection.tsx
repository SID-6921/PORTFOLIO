...
const projects = [
  {
    ...
    techStack: ["Python", "TensorFlow", "OpenCV", "Flask", "React", "PostgreSQL"],
    category: "AI",
    githubUrl: "#",
    demoUrl: "#",
    date: "2024",
  ...
  },
  {
    ...
    techStack: ["Arduino", "ESP32", "React Native", "Firebase", "C++", "Bluetooth LE"],
    category: "IoT",
    githubUrl: "#",
    date: "2023",
    team: "Team of 3"
  },
  {
    ...
    techStack: ["React", "Node.js", "WebRTC", "MongoDB", "Socket.io", "AWS"],
    category: "Web",
    githubUrl: "#",
    demoUrl: "#",
    date: "2023",
  ...
  },
  {
    ...
    techStack: ["MATLAB", "Python", "DSP", "LabVIEW", "C++"],
    category: "Biomedical",
    githubUrl: "#",
    date: "2024",
    team: "Research Team"
  ...
  },
  {
    ...
    techStack: ["Python", "PyTorch", "OpenCV", "Django", "PostgreSQL", "Docker"],
    category: "AI",
    githubUrl: "#",
    date: "2024",
