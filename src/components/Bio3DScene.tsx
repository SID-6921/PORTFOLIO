        ...
        .map((_, i) => {
          ...
          return (
            <mesh
              ...
              castShadow
              receiveShadow
              geometry={isOne ? boxGeometry : sphereGeometry}
              material={isOne ? boxMaterial : sphereMaterial}
            />
          );
        })}
    </group>
...
function PulseHeartDot() {
  ...
  return (
    <mesh ref={meshRef} position={[baseX, baseY, 0.06]} geometry={geometry} material={material} />
  );
}
