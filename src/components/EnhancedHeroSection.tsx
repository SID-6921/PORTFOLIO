...
export default function EnhancedHeroSection() {
  ...
  const fallbackContent = {
    ...
    resume_url:
      "https://drive.google.com/file/d/1vI1YJ1b7lb0qu8PJZ4h7UK4INZXSmHZ_/view?usp=sharing",
  };
      ...
      >
        <DashboardCard variant="elevated" className="p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            {/* Bio Wave */}
            <motion.div variants={itemVariants} className="my-8 flex justify-center">
              <BioWaveSVG />
            </motion.div>
            ...
            {/* Download Resume Button Only & Centered */}
            ...
            {/* Scroll Indicator */}
            <motion.div variants={itemVariants} className="mt-16 flex flex-col items-center text-gray-500 dark:text-gray-400">
