...
export default function EnhancedHeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-6 py-20">
      ...
      {/* Subtle ECG overlay */}
      <SubtleBioOverlay variant="ecg" intensity="low" />
      ...
      <motion.div
        ...
        animate="visible"
      >
        <ProfessionalCard variant="elevated" className="p-12 text-center relative overflow-hidden">
          {/* Additional DNA strand overlay for the card */}
          <div className="absolute inset-0 opacity-[0.015] dark:opacity-[0.025]">
            <SubtleBioOverlay variant="dna" intensity="low" />
          </div>
