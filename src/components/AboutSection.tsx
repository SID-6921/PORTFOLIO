...
import SubtleBioOverlay from "./SubtleBioOverlay";
...
export default function AboutSection() {
  return (
    <section id="about" className="relative py-20 min-h-[35vh] flex justify-center bg-transparent">
      {/* Subtle biomedical overlay */}
      <SubtleBioOverlay variant="neural" intensity="low" />
      ...
      >
        <ProfessionalCard variant="default" className="p-10 relative overflow-hidden">
          {/* Additional subtle molecular overlay for the card */}
          <div className="absolute inset-0 opacity-[0.02] dark:opacity-[0.04]">
            <SubtleBioOverlay variant="molecular" intensity="low" />
          </div>
